...
router.get('/response/guest/:guestId', authorizeRoles([Roles.EDITOR, Roles.ADMIN, Roles.READONLY, Roles.GUEST]), (req, res, next) => surveyController.getAllSurveyResponsesForGuest(req, res, next));
