...
router.get('/', authorizeRoles([Roles.EDITOR, Roles.ADMIN, Roles.READONLY, Roles.TRIO, Roles.GUEST]), (req, res, next) => guestController.getGuests(req, res, next));
...
router.get('/subevent/:subEventId', authorizeRoles([Roles.EDITOR, Roles.ADMIN, Roles.READONLY, Roles.TRIO]), (req, res, next) => guestController.getGuestsForSubEvent(req, res, next));
router.get('/accommodation/:accommodationId', authorizeRoles([Roles.EDITOR, Roles.ADMIN, Roles.READONLY, Roles.TRIO]), (req, res, next) => guestController.getGuestsByAccommodation(req, res, next));
...
router.get('/download', authorizeRoles([Roles.EDITOR, Roles.ADMIN, Roles.TRIO]), (req, res, next) => guestController.downloadGuests(req, res, next));
