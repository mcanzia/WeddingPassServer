...
router.get('/', authorizeRoles([Roles.READONLY, Roles.EDITOR, Roles.ADMIN]), (req, res, next) => eventController.getEvents(req, res, next));
router.get('/id/:eventId', authorizeRoles([Roles.READONLY, Roles.EDITOR, Roles.ADMIN]), (req, res, next) => eventController.getEventbyId(req, res, next));
router.get('/name/:eventName', authorizeRoles([Roles.READONLY, Roles.EDITOR, Roles.ADMIN]), (req, res, next) => eventController.getEventbyName(req, res, next));
