...
func initControllers(container *dig.Container) error {
	return util.ChainFunctions(
		...
		func() error { return container.Provide(accommodation.NewHotelController) },
		...
		func() error {
			return container.Provide(func(
				...
				hotelCtrl *accommodation.HotelController,
...
func initServices(container *dig.Container) error {
	return util.ChainFunctions(
		...
		func() error { return container.Provide(accommodation.NewHotelService) },
...
func initRepositorys(container *dig.Container) error {
	return util.ChainFunctions(
		...
		func() error { return container.Provide(accommodation.NewHotelRepository) },
